...
func getMealLog(for meal: String) -> Meal? {
    return meals[meal]
}
print
if let breakfastMeal = getMealLog(for: "Breakfast") {
    print(breakfastMeal)
} else {
    print("No breakfast meal .")
}

if let lunchMeal = getMealLog(for: "Lunch") {
    print(lunchMeal)
} else {
    print("No lunch meal.")
}
 ...
 */
func getSavedMealLog() -> [String: Any] {
