 ...
 */
 let mixedCollection: [Any] = [42.0,42,"The answer to life, the universe, and everything",true,3.14]
...
for (_, value) in mixedDictionary {
    if let intValue = value as? Int {
        ...
        total2 += doubleValue
              ...
              let numericValue = Double(stringValue) {
        total2 += numericValue
    }
