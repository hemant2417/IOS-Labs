...
var averageMileTimeWorkout = RunningWorkout(distance: 1600, time: 30, elevation: 0)
print(averageMileTimeWorkout.time)
print(averageMileTimeWorkout.distance)
print(averageMileTimeWorkout.elevation)
print("Average mile time: \(averageMileTimeWorkout.time / averageMileTimeWorkout.distance) seconds per mile")
/*:
